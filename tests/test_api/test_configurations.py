...
def test_get_configs_with_provided_project(
    ...
    api_configurations = testrail_client.get_configs(project_id=1)
...
def test_get_configs_with_set_project(
    ...
    api_configurations = testrail_client.get_configs()
...
def test_add_config_group_with_provided_project(testrail_client, mocked_response):
    ...
    api_config_group = testrail_client.add_config_group(name='Test Group', project_id=1)
...
def test_add_config_group_raises(testrail_client, mocked_response):
    ...
    with pytest.raises(TestRailException):
        testrail_client.add_config_group(name='Test Group')
...
def test_add_config(testrail_client, mocked_response):
    ...
    api_config = testrail_client.add_config(name='Test Config', config_group_id=1)
...
def test_update_config_group(testrail_client, mocked_response):
    ...
    api_config_group = testrail_client.update_config_group(name='New Test Group', config_group_id=1)
...
def test_update_config(testrail_client, mocked_response):
    ...
    api_config = testrail_client.update_config(name='New Test Config', config_id=1)
...
def test_delete_config_group(testrail_client, mocked_response):
    ...
    response = testrail_client.delete_config_group(config_group_id=1)
...
def test_delete_config(testrail_client, mocked_response):
    ...
    response = testrail_client.delete_config(config_id=1)
