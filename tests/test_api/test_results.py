...
def test_get_results(testrail_client, mocked_response, result_data, result):
    ...
    api_results = testrail_client.get_results(test_id=1)
...
def test_get_results_for_case(testrail_client, mocked_response, result_data, result):
    ...
    api_results = testrail_client.get_results_for_case(run_id=1, case_id=1)
...
def test_get_results_for_run(testrail_client, mocked_response, result_data, result):
    ...
    api_results = testrail_client.get_results_for_run(run_id=1)
...
def test_add_result(testrail_client, mocked_response):
    ...
    api_result = testrail_client.add_result(test_id=1, result=expected_result)
...
def test_add_result_for_case(testrail_client, mocked_response):
    ...
    api_result = testrail_client.add_result_for_case(run_id=1, case_id=1, result=expected_result)
...
def test_add_results(testrail_client, mocked_response):
    ...
    api_results = testrail_client.add_results(run_id=1, results=[expected_result])
...
def test_add_results_for_cases(testrail_client, mocked_response):
    ...
    api_results = testrail_client.add_results_for_cases(run_id=1, results=[expected_result])
